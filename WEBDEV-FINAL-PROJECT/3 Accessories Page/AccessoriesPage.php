...
if(in_array($_POST['product_id'], $item_array_id)){
    ...
    echo "<script>window.location = 'AccessoriesPage.php'</script>";
}else{
...
<head>
    <!--<meta charset="utf-8" />-->
    <title>Eclipse Games - Accessories</title>
    <link rel="stylesheet" type="text/css" href="AccessoriesPage.css" />
</head>
<body>
    ...
    <div class="body">
        ...
        <div class="small-container">
            ...
            <?php 
                                    ...
                                    if($row['id'] > 34){
                                        component_accessoriesPage($row['product_name'], $row['product_price'], $row['product_console'], $row['product_image'], $row['id'],$row['description_page']);
                                    }
        ...
        <br /><br />
        <div class="small-container">
            <h1 class="title">RACING WHEELS</h1>
            <br />
            <select>
                <option>Sort by Price</option>
                <option>Sort by Popularity</option>

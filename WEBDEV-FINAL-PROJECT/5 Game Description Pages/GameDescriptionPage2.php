...
if(in_array($_POST['product_id'], $item_array_id)){
    ...
    echo "<script>window.location = 'GameDescriptionPage2.php'</script>";
}else{
...
<head>
    <!--<meta charset="utf-8" />-->
    <title>Eclipse Games - Call of Duty: Modern Warfare II</title>
    <link rel="stylesheet" type="text/css" href="GameDescriptionPage2Style.css" />
</head>
<body>
